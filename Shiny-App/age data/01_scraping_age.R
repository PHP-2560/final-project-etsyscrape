...
# this one worked and will be used for shiny app
...
saveRDS(IARD_age_table, "C:/Users/akosu/Desktop/final-project-etsyscrape/Shiny-App/age data/min_age_table.rds" )
